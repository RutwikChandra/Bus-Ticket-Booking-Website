<?php
  ...
  r.distance, 
  s.date, 
  (36-COUNT(p.Passenger_id)) AS available_seats
FROM 
  Schedules s
JOIN 
...
LEFT JOIN 
  Passengers p ON bk.booking_id = p.booking_id
WHERE 
  r.origin = ? AND 
  r.destination = ? AND 
  s.date = ?
...
<head>
    ...
    <link rel="stylesheet" href="navbar.css?12cgn34">
  ...
  <div class="schedule-list-container">
    ...
    <?php
      ...
      foreach ($rows as $row) {
        ...
        $price = intval(1200*($distance/650)*(660/$duration_min));
