<?php
    ...
    $sql = "INSERT INTO Bookings (user_id, schedule_id, booking_date, status) VALUES (1, ?, CURRENT_DATE, 'ok')";
    ...
    $stmt->bind_param("i", $_SESSION['schedule_id']);
...
<div class="header">
  ...
  <div style="margin: auto; width: fit-content; color: #ffc107; font-size: 25px; margin-top: 0px; margin-bottom: 30px;" class="selected_seats_info_text">Ticket Booked Successfully :)</div>
