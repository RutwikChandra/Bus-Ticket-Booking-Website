<?php
  ...
  $sql = "SELECT p.seat_number FROM Passengers p JOIN Bookings b ON p.booking_id = b.booking_id WHERE b.schedule_id = ?";
...
<head>
    ...
    <link rel="stylesheet" href="navbar.css?vv12v34">
...
<body style="margin: 0px; background-color: rgb(58, 55, 55);">
    ...
    <div class="navbar-container">
      ...
      <div style="margin: auto; width: fit-content; color: #ffc107; font-size: 25px; margin-top: 0px;" class="selected_seats_info_text">Select Your Seats</div>
      <div class="container">
          ...
          <li class="contents" style="margin-right: 0px;">
            <div class="selected_seats_info">
              ...
              <div>
                ...
                <div style="display: flex; align-items: center; margin-top: 12px;"><div class="selected_seats_info_text" style="font-weight: 300; font-size: 14px; width: fit-content; margin-right: auto;">Amount</div><div id="amount" class="selected_seats_info_text" style="font-weight: 500; font-size: 14px;">INR 0.00</div></div>
                <div id="proceed_to_book" onclick="send_selected_seats()" class="selected_seats_info_text" style="font-weight: 300; font-size: 14.5px; display: flex; justify-content: center; background-color: #ffc107; padding: 8px 0px; margin-top: 18px; cursor: pointer;">PROCEED TO BOOK</div>
              </div>
      ...
      <script>
        ...
        function push_selected_seats(seatIds){
        ...
        function updateSeatList() {
          ...
          let amount_div = document.getElementById("amount");
          let text = 'INR '+ (seatIds.length)*<?php echo $_SESSION['price']; ?> + '.00';
          amount_div.innerHTML = text;
        }

        function send_selected_seats(){
          let seatIds = [];
          push_selected_seats(seatIds);
          ...
          if(seatIds.length == 0){
            ...
            $.ajax({
                type: 'POST',
                url: 'passenger_details.php',
                data: { seats_info: JSON.stringify(seatIds) },
