...
<head>
    ...
    <link rel="stylesheet" href="navbar.css?yyfk">
...
<div class="header">
  ...
  <form style="transform: scale(1.3); width: fit-content; margin: auto;" action="busses.php" method="post">
    <div style="width: fit-content; margin: auto; margin-top: 250px; background-color: white; padding: 20px 20px; box-shadow: 0px 0px 10px black;">
